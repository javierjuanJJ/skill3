...
class Calculator {
  ...
  /**
   * Modulo operation - returns the remainder of previousValue divided by currentValue
   */
  ...
  /**
   * Exponentiation operation - returns previousValue raised to the power of currentValue
   */
  power(base, exponent) {
  ...
  calculate(previous, current, op) {
    switch (op) {
      ...
      case '%':
        return this.modulo(previous, current);
      case '^':
        return this.power(previous, current);
      default:
        return current;
    }
  }
